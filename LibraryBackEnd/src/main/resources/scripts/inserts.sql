...
INSERT IGNORE INTO users (id_user, dni, email, name, last_name, phone_number, address, is_active) VALUES (1, '1111121', 'Ro.alcala@hotmail.com', 'Rocio', 'Alcala', '1111111121', 'Calle Falsa 123', true);
...
INSERT IGNORE INTO books (id_book, title, isbn, id_genre, quantity, id_author, id_editorial, id_image, is_active) VALUES (1, 'Harry Potter 1', '978-3-16-148410-1', 1, 2, 1, 1, 1, true);
INSERT IGNORE INTO books (id_book, title, isbn, id_genre, quantity, id_author, id_editorial, id_image, is_active) VALUES (2, 'Cien años de soledad', '978-3-16-148410-2', 2, 5, 2, 2, 1, true);
INSERT IGNORE INTO books (id_book, title, isbn, id_genre, quantity, id_author, id_editorial, id_image, is_active) VALUES (3, 'El túnel', '978-3-16-148410-3', 3, 10, 3, 3, 1, true);
INSERT IGNORE INTO books (id_book, title, isbn, id_genre, quantity, id_author, id_editorial, id_image, is_active) VALUES (4, 'Martín Fierro', '978-3-16-148410-4', 4, 8, 4, 4, 1, true);
INSERT IGNORE INTO books (id_book, title, isbn, id_genre, quantity, id_author, id_editorial, id_image, is_active) VALUES (5, 'Don Quijote de la Mancha', '978-3-16-148410-5', 1, 12, 5, 5, 1, true);
INSERT IGNORE INTO books (id_book, title, isbn, id_genre, quantity, id_author, id_editorial, id_image, is_active) VALUES (6, 'Fahrenheit 451', '978-3-16-148410-6', 2, 6, 1, 2, 1, true);
